...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Your Trusted Toys Store">
        <meta name="keywords" content="ecommerce,Toys">
        <meta name="author" content="422021009-Andhika">

        <title>@yield('title') | 422021009-Andhika</title>
        <link rel="icon" type="image/x-icon" href="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSfy3vPMzYPGpplbhnl5Ne0LBUIQmkhfnvZUg&s">
        <!-- BEGIN: CSS Assets-->
